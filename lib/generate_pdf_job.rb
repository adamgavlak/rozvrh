class GeneratePdfJob < Struct.new(:doc_id)
  ...
  def perform
    ...
    pdf_html = av.render(template: "teachers/_teacher.html.erb", layout: "layouts/pdf.html.erb", locals: {teacher: teacher, lecture: lecture, classes: classes, labs: labs, total: total})
